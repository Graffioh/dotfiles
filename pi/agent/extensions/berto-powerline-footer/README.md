<p>
  <img src="banner.png" alt="berto-powerline-footer" width="1100">
</p>

# berto-powerline-footer
...
```bash
Use as a local extension from ~/.pi/agent/extensions/berto-powerline-footer
```
