...
At the end of the run, check that the log tells the truth. Use the current conversation and, when available, the current task's thread record and subagent results. Never scan unrelated tasks. Walk the log against what actually happened:
