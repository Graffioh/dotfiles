...
![She tastes a finished dish while robots cook from a recipe box, with pinned cards reading $how, $tdd, and the recurring monitoring or wait mechanism above the counter.](./images/recipes.jpg)
...
- **A vague finish condition.** "make it better" gives the recurring monitoring or wait mechanism nothing to check. Give a command or artifact that can pass or fail.
